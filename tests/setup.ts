...
process.env.DATABASE_URL = 'postgresql://postgres:postgres@localhost:5432/hellominds_connector_test';
...
process.env.BOT_MGMT_API_URL = 'https://bot-mgmt.example.com';
process.env.BOT_MGMT_API_KEY = 'test-bot-mgmt-api-key-32chars-xxxx';
process.env.SES_FROM_ADDRESS = 'noreply@example.com';
process.env.EXA_API_KEY = 'test-exa-api-key';
process.env.WEBFETCH_RATE_LIMIT_MAX = '10';
process.env.WEBFETCH_RATE_LIMIT_WINDOW_MS = '60000';
process.env.WEBFETCH_DOMAIN_ALLOWLIST = '';
